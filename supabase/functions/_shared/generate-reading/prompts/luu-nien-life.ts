...
- Mỗi "text": **~500 ký tự** tiếng Việt có dấu (tối thiểu 450, mục tiêu 500–600), chia **đúng 3 đoạn** ngăn bằng \\n\\n (mỗi đoạn **3–5 câu hoàn chỉnh**).
...
Mỗi life_area_readings[].text ~500 ký tự (tối thiểu 450), đúng 3 đoạn (\\n\\n), mỗi đoạn 3–5 câu, nêu thuận lợi và khó khăn năm. Tạo đúng số mục bằng data.life_areas — không thêm, không bớt.`;
