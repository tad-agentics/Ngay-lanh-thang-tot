...
const TIEU_VAN_LUU_NIEN_PROMPT_VER = "2026-03-29a";
...
Ba khóa bắt buộc. Mỗi giá trị là một chuỗi tiếng Việt văn xuôi, **đúng 6–7 câu** (không ngắn hơn 5 câu mỗi khóa), không gạch đầu dòng, không ký hiệu liệt kê:
...
const TIEU_VAN_LUU_NIEN_JSON_RETRY =
  `Chỉ trả về một object JSON với đúng ba khóa: "nhin_chung", "thuc_tien", "ung_xu". Mỗi giá trị: string, 6–7 câu tiếng Việt văn xuôi; nếu data có Dụng Thần hoặc Thập Thần tháng thì phải giải thích ngắn ý nghĩa và ảnh hưởng gợi ý. Không markdown, không code fence.`;
