-- Canonical rows for feature_credit_costs + app_config.
-- seed.sql mirrors this for local reset; migrations ensure hosted DB gets data without running seed.
...
-- Align with app/lib/constants.ts + supabase/seed.sql (+ Make FEATURE_COSTS / tech-spec §4)
