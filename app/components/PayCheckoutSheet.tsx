...
export function PayCheckoutSheet({
  ...
  /** Where "Tôi đã chuyển khoản" navigates — must include order_id if polling needed. */
        ...
        >
          ...
          <SheetFooter className="px-4 pb-[max(1.25rem,env(safe-area-inset-bottom))] pt-3 border-t border-border/60 bg-background flex flex-col gap-2">
            ...
            <p className="text-xs text-muted-foreground text-center leading-relaxed">
              Sau khi chuyển khoản đúng số tiền và nội dung, hệ thống tự gia hạn
              lịch khi PayOS gửi webhook. Trang này tự kiểm tra vài phút — lệnh
              hết hạn sau 15 phút.
            </p>
