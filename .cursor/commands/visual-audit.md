...
- Make fidelity — compare staging screens against Make's original component code (colors, spacing, typography, missing elements)
...
- Dopamine moment fidelity — for D1–D4 flagged screens: verify animation timing matches EDS §6
