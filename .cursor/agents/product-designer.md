...
- **Make fidelity** — compare rendered screens against the original Make component code. Flag: wrong colors, mismatched spacing, missing elements, incorrect typography, layout drift introduced during porting.
